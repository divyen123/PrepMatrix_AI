...
const DESTINATIONS = Object.freeze([
  ...
  defineDestination({
    ...
    label: "Goals & To-Do",
    description: "Dated goals and quick to-do tasks",
    content: true,
    ...
    intentPatterns: [
      /\b(?:open|show|view|check|manage|add|create)\s+(?:my\s+|the\s+|a\s+)?(?:goals?|(?:quick\s+)?to[ -]?dos?|goals?\s+(?:and\s+)?(?:quick\s+)?to[ -]?dos?)\b/,
    ],
  }),
  defineDestination({
    id: "kids",
