    ...
    <section className="page-stack quiz-page">
      ...
      {questions.length > 0 && (
        <section className="card quiz-runner-card">
          <div className="quiz-runner-header" style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: "12px" }}>
            <div>
            ...
            <div style={{ display: "flex", gap: "10px", alignItems: "center" }}>
              <button 
                ...
                type="button" 
                style={{ padding: "6px 12px", fontSize: "0.76rem", minHeight: "32px", height: "32px", display: "inline-flex", alignItems: "center", justifyContent: "center" }}
              >
                Export PDF
              </button>
              {result && <strong className="quiz-score-chip" style={{ margin: 0 }}>Score {result.score}/{result.total}</strong>}
            </div>
          </div>
