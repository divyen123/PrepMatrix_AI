...
//#endregion
//#region node_modules/@jitl/quickjs-wasmfile-release-asyncify/dist/ffi.mjs
var QuickJSAsyncFFI = class {
	constructor(module) {
		...
		this.QTS_ExecutePendingJob = assertSync(this.module.cwrap("QTS_ExecutePendingJob", "number", [
			"number",
			"number",
			"number"
		]));
		...
		this.QTS_GetProp = assertSync(this.module.cwrap("QTS_GetProp", "number", [
			"number",
			"number",
			"number"
		]));
		...
		this.QTS_GetPropNumber = assertSync(this.module.cwrap("QTS_GetPropNumber", "number", [
			"number",
			"number",
			"number"
		]));
		...
		this.QTS_SetProp = assertSync(this.module.cwrap("QTS_SetProp", null, [
			"number",
			"number",
			"number",
			"number"
		...
		this.QTS_GetOwnPropertyNames = assertSync(this.module.cwrap("QTS_GetOwnPropertyNames", "number", [
			"number",
			"number",
			"number",
			"number",
		...
		this.QTS_Call = assertSync(this.module.cwrap("QTS_Call", "number", [
			"number",
			"number",
			"number",
			"number",
		...
		this.QTS_Eval = assertSync(this.module.cwrap("QTS_Eval", "number", [
			"number",
			"number",
			"number",
			"string",
