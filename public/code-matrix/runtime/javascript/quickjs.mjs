...
//#endregion
//#region node_modules/quickjs-emscripten-core/dist/chunk-V2S4ZYJR.mjs
function setDebugMode(enabled = !0) {
	QTS_DEBUG = enabled;
}
...
Lifetime used`) : new QuickJSUseAfterFree("Lifetime not alive");
	...
	DefaultIntrinsics = Object.freeze({
		BaseObjects: !0,
		Date: !0,
		Eval: !0,
		StringNormalize: !0,
	...
	INT32_MIN = -2147483648, INT32_MAX = 2147483647, INVALID_HOST_REF_ID = 0;
	HostRefMap = class {
		constructor() {
...
//#endregion
//#region node_modules/quickjs-emscripten-core/dist/chunk-TAV5CUKK.mjs
var QuickJSAsyncContext, QuickJSAsyncRuntime, QuickJSAsyncWASMModule;
var init_chunk_TAV5CUKK = __esmMin((() => {
	init_chunk_V2S4ZYJR();
	...
	QuickJSAsyncRuntime = class extends QuickJSRuntime {
		...
		newContext(options = {}) {
			let intrinsics = intrinsicsToFlags(options.intrinsics), ctx = new Lifetime(this.ffi.QTS_NewContext(this.rt.value, intrinsics), void 0, (ctx_ptr) => {
				this.contextMap.delete(ctx_ptr), this.callbacks.deleteContext(ctx_ptr), this.ffi.QTS_FreeContext(ctx_ptr);
			}), context = new QuickJSAsyncContext({
				module: this.module,
				ctx,
				ffi: this.ffi,
				rt: this.rt,
	...
	QuickJSAsyncWASMModule = class extends QuickJSWASMModule {
		...
		newRuntime(options = {}) {
			...
			}), runtime = new QuickJSAsyncRuntime({
				module: this.module,
				ffi: this.ffi,
				rt,
				callbacks: this.callbacks
		...
		newContext(options = {}) {
			let runtime = this.newRuntime(), lifetimes = options.ownedLifetimes ? options.ownedLifetimes.concat([runtime]) : [runtime], context = runtime.newContext({
				...options,
...
//#endregion
//#region node_modules/quickjs-emscripten-core/dist/module-ES6BEMUI.mjs
...
//#endregion
//#region node_modules/quickjs-emscripten-core/dist/module-asyncify-2EFITU5U.mjs
var module_asyncify_2EFITU5U_exports = /* @__PURE__ */ __exportAll({ QuickJSAsyncWASMModule: () => QuickJSAsyncWASMModule });
var init_module_asyncify_2EFITU5U = __esmMin((() => {
	init_chunk_TAV5CUKK();
}));
//#endregion
//#region node_modules/quickjs-emscripten-core/dist/index.mjs
init_chunk_TAV5CUKK();
init_chunk_V2S4ZYJR();
init_dist();
...
async function newQuickJSAsyncWASMModuleFromVariant(variantOrPromise) {
	let variant = smartUnwrap(await variantOrPromise), [wasmModuleLoader, QuickJSAsyncFFI, { QuickJSAsyncWASMModule: QuickJSAsyncWASMModule2 }] = await Promise.all([
		variant.importModuleLoader().then(smartUnwrap),
		variant.importFFI(),
		Promise.resolve().then(() => (init_module_asyncify_2EFITU5U(), module_asyncify_2EFITU5U_exports)).then(smartUnwrap)
	]), wasmModule = await wasmModuleLoader();
